...
export const trendingVideos: Video[] = [
  ...
  },
  {
    ...
    description:
      "A student-produced short film by CityCast — storytelling through cinema, made entirely by CCNY students.",
...
export const additionalVideos: Video[] = [
  {
    ...
    description:
      "CityCast covers the Outlet Showcase 2025, highlighting student creativity and spreading awareness through art and media.",
