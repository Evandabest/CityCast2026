...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about CityCast - CCNY's student-run campaign media platform for the Undergraduate Student Government.",
};
...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
      <RevealSection>
        <PageTitle
          glitchText="About CityCast"
          subtitle="CCNY's student-run campaign media platform — covering events, producing videos, and telling the stories that matter."
        >
          About <span className="text-blue-400">CityCast</span>
        </PageTitle>
      </RevealSection>
        ...
        <RevealSection>
          <GlassCard padding="lg">
            ...
            <p className="text-slate-300 leading-relaxed">
              CityCast is a student-run campaign media platform for CCNY&apos;s Undergraduate Student
              Government. From campaign event coverage and candidate spotlights to photography
              and video production &mdash; if it&apos;s happening at CCNY, we&apos;re there covering it.
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  ...
                  across Instagram. Follow @citycast for the latest.
                </p>
              </div>
            </div>
          </GlassCard>
        ...
        <RevealSection>
          <section className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] backdrop-blur-sm px-6 py-10 md:px-10 md:py-12 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-slate-400 mb-6">The leaders driving CityCast forward.</p>
              <TeamShowcase />
            </div>
          </section>
        </RevealSection>
