...
export const metadata: Metadata = {
  title: "Join CityCast",
  description: "Join CityCast — CCNY's student-run campaign media platform. No experience needed — apply to become a member.",
};
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
      ...
      <GlassCard padding="lg">
        <div className="text-center py-12">
          ...
          <a
            href="https://instagram.com/citycast"
            target="_blank"
