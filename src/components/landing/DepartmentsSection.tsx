...
const siteLinks = [
  ...
  },
  {
    ...
    name: "Instagram",
    href: "/instagram",
    description: "Behind-the-scenes photography and highlights from @citycast",
  },
  {
    number: "03",
    name: "About Us",
    href: "/about",
    description: "Our mission, our team, and how we bring CCNY's stories to life",
  },
  {
    number: "04",
    name: "Join",
    href: "/join",
    description: "Apply to become a member of CityCast",
  },
] as const;
