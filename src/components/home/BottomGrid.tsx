...
const features = [
  {
    ...
    description: "We film interviews, events, documentaries, and anything worth watching at CCNY.",
  ...
  },
  {
    ...
    description: "Long-form conversations with students, faculty, and alumni about life at CCNY.",
