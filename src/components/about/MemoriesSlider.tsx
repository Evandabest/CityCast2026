...
const memories: LuminaSlide[] = [
  ...
  },
  {
    title: "The Team",
    description:
      "CityCast 2025 — the faces behind every frame, every edit, every story we tell.",
  ...
  },
  {
    title: "Opening Night",
    description:
      "Curtain up on STC's The Importance of Being Earnest — every moment captured by CityCast.",
