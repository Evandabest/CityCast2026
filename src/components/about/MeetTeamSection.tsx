...
const roster: PersonInfo[] = [
  ...
  { name: "Anderson Oh", roles: ["Vice President", "Director"], permission: 3, bio: "CityCast Leadership", photo: "/team/anderson-oh.jpg", crews: ["Vice President", "Treasury"], customTitle: "VP of Finance" },
  { name: "Anders Zernike", roles: ["Director"], permission: 1, bio: "CityCast Leadership", photo: "/team/anders-zernike.jpg", crews: ["Photography"], customTitle: "" },
  ...
  { name: "Jerry Qiu", roles: ["President", "Director"], permission: 4, bio: "Jerry is a senior at CCNY with a passion for aviation, music, and media. During Junior SING! 2025, he rediscovered a lifelong love for storytelling and has since dedicated himself to capturing moments that matter. He regularly creates content for CityCast, other clubs, and the broader school community, from short-form videos to photo collages on Instagram. As a President, he is excited to keep filming and photographing at CCNY while helping the next generation of CityCast members grow in their creative journeys.", photo: "/team/jerry-qiu.jpg", crews: ["Board", "Video Production"], customTitle: "President, Engagement" },
  ...
  { name: "Max Yang", roles: ["Board"], permission: 2, bio: "CityCast Leadership", photo: "/team/max-yang.jpg", crews: ["Board"], customTitle: "Chief Editorial Officer" },
  ...
  { name: "Ryan Radwan", roles: ["Board"], permission: 2, bio: "Ryan is the founder of CityCast, having graduated as part of the Class of 2025. He dedicated his sophomore, junior, and senior years to building the platform from the ground up, and now focuses on continuing to support the future generations that will power the premier student media platform at CCNY for years to come. As the Alumni Relations Coordinator, he helps newer members learn from experienced alumni and creates opportunities for them to connect with the broader media industry.", photo: "/team/ryan-radwan.jpg", crews: ["Board"], customTitle: "Alumni Relations Coordinator" },
